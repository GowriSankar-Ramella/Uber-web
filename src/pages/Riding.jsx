...
const Riding = () => {
    ...
    useEffect(() => {
        ...
        // Only proceed if socket exists (should be created from Home component)
        if (!socket) {
            console.warn("No socket instance found, redirecting to home")
            navigate('/home')
            return
        }
        ...
        // Cleanup function - only remove listener, don't disconnect
        return () => {
            if (socket) {
