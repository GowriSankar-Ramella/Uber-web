...
const CaptainHome = () => {
    ...
    useEffect(() => {
        ...
        socketInstance.on('connect', () => {
            ...
            socketInstance.emit("join", { userType: "captain", userId: captain._id })
        })
        ...
        const updateLocation = () => {
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(position => {
                    ...
                    socketInstance.emit('update-location-captain', {
                        userId: captain._id,
                        location: {
        ...
        // Cleanup function - only remove specific listeners and clear interval
        return () => {
            clearInterval(locationInterval)
            if (socketInstance) {
                socketInstance.off('new-ride')
